...
#             priorityList.swap(priorityList.begin(), keyToIt[key]);
#             return *keyToIt[key];
#         }
...
#     // exist -> update priority, update value. done
#     // not exist -> push_front, check size
#     // 1. Update priority
...
#         } 
#         priorityList.push_front(value);
#         keyToIt[key] = priorityList.front();
        
#         if (priorityList.size() > size) {
#             keyToIt.erase(*priorityList.back());
