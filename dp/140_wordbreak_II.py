...
#  Category: DP.
#  Runtime:  O(N^2), as there are N^2 substrings in a string, at most we cache a result for
#                    every substring.
#  Note: There's a BFS Soln to word break I, would doing a BFS of paths like word ladder II work?
#  
